RunHub::Application.routes.draw do
  ...
  match 'profiles/:user_id/workouts' => 'profiles#show_this_week'
  match 'profiles/:user_id/workouts/:start_date' => 'profiles#show_week', :constraints => { :start_date => /\d+-\d+-\d+/ }, :as => :public_workouts
